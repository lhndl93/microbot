...
public enum FarmPatch {
    ...
    FARMING_GNOME_STRONGHOLD(ItemID.CAMELOT_TELEPORT, new WorldPoint(2436, 3416, 0), NpcID.PRISSY_SCILLA, true),           // Fruit tree
    ...
    FARMING_GNOME_STRONGHOLD_FRUIT(ItemID.XERICS_TALISMAN, new WorldPoint(2473, 3447, 0), NpcID.BOLONGO, true);  // Fruit tree in Gnome Stronghold
